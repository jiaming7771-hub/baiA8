...
EXIT_REASONS = {
    ...
    "tier_tp": "普通档止盈：浮盈达标后剩余仓一次清完",
    "failed_breakout": "优质档曾冲高后又跌回，假突破早砍全清",
...
_REASON_FMT = {
    ...
    "tier_tp": "普通档止盈+{pct:g}%（剩余仓全清）",
    "failed_breakout": "优质假突破：曾冲高≥+{pct:g}%后回落，全清",
